...
const (
	Shipping_Create_FullMethodName = "/yoshikishibata.courier.example.api.shipping.v1.Shipping/Create"
	Shipping_Status_FullMethodName = "/yoshikishibata.courier.example.api.shipping.v1.Shipping/Status"
)
...
func (c *shippingClient) Status(ctx context.Context, in *ShippingStatusRequest, opts ...grpc.CallOption) (*ShippingStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, Shipping_Status_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Shipping_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Shipping_Status_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
